...
-- ----------------------------
-- Table structure for codedetail
-- ----------------------------
...
-- ----------------------------
-- Records of codedetail
-- ----------------------------
INSERT INTO `codedetail` VALUES (1, 1, '步骤类型', 101, '浏览器操作');
INSERT INTO `codedetail` VALUES (2, 1, '步骤类型', 102, '弹窗操作');
INSERT INTO `codedetail` VALUES (3, 1, '步骤类型', 103, '元素操作');
INSERT INTO `codedetail` VALUES (4, 1, '步骤类型', 104, '鼠标操作');
INSERT INTO `codedetail` VALUES (5, 1, '步骤类型', 105, '流程控制');
INSERT INTO `codedetail` VALUES (6, 101, '浏览器操作类型', 1011, '打开网页');
INSERT INTO `codedetail` VALUES (7, 101, '浏览器操作类型', 1012, '关闭网页');
INSERT INTO `codedetail` VALUES (8, 101, '浏览器操作类型', 1013, '切换窗口');
INSERT INTO `codedetail` VALUES (9, 101, '浏览器操作类型', 1014, '设置窗口大小');
INSERT INTO `codedetail` VALUES (10, 103, '元素操作类型', 1031, '提交表单');
INSERT INTO `codedetail` VALUES (11, 103, '元素操作类型', 1032, '下拉框操作');
INSERT INTO `codedetail` VALUES (12, 103, '元素操作类型', 1033, '设置选项');
INSERT INTO `codedetail` VALUES (13, 103, '元素操作类型', 1034, '等待元素');
INSERT INTO `codedetail` VALUES (14, 104, '鼠标操作类型', 1041, '鼠标点击');
INSERT INTO `codedetail` VALUES (15, 104, '鼠标操作类型', 1042, '鼠标移动');
INSERT INTO `codedetail` VALUES (16, 104, '鼠标操作类型', 1043, '鼠标拖拽');
INSERT INTO `codedetail` VALUES (17, 105, '流程控制类型', 1051, '次数循环');
INSERT INTO `codedetail` VALUES (18, 1013, '切换窗口类型', 10131, '切换到初始窗口');
INSERT INTO `codedetail` VALUES (19, 1013, '切换窗口类型', 10132, '根据网页索引号切换到指定窗口');
INSERT INTO `codedetail` VALUES (20, 1014, '设置窗口大小类型', 10141, '窗口最大化');
INSERT INTO `codedetail` VALUES (21, 1014, '设置窗口大小类型', 10142, '指定尺寸（像素为单位）');
INSERT INTO `codedetail` VALUES (22, 2, '元素定位类型', 201, 'id');
INSERT INTO `codedetail` VALUES (23, 2, '元素定位类型', 202, 'name');
INSERT INTO `codedetail` VALUES (24, 2, '元素定位类型', 203, 'classname');
INSERT INTO `codedetail` VALUES (25, 2, '元素定位类型', 204, 'tagname');
INSERT INTO `codedetail` VALUES (26, 2, '元素定位类型', 205, 'linktext');
INSERT INTO `codedetail` VALUES (27, 2, '元素定位类型', 206, 'xpath');
INSERT INTO `codedetail` VALUES (28, 2, '元素定位类型', 207, 'label');
INSERT INTO `codedetail` VALUES (29, 2, '元素定位类型', 208, 'value');
INSERT INTO `codedetail` VALUES (30, 2, '元素定位类型', 209, 'index');
INSERT INTO `codedetail` VALUES (31, 2, '元素定位类型', 2010, 'css');
INSERT INTO `codedetail` VALUES (32, 3, '前置操作类型', 301, '等待时间');
INSERT INTO `codedetail` VALUES (33, 3, '前置操作类型', 302, '截图');
INSERT INTO `codedetail` VALUES (34, 4, '后置操作类型', 401, '等待时间');
INSERT INTO `codedetail` VALUES (35, 4, '后置操作类型', 402, '断言');
INSERT INTO `codedetail` VALUES (36, 4, '后置操作类型', 403, '截图');
INSERT INTO `codedetail` VALUES (37, 402, '断言类型', 4021, '元素断言');
INSERT INTO `codedetail` VALUES (38, 402, '断言类型', 4022, '弹窗文本');
INSERT INTO `codedetail` VALUES (39, 402, '断言类型', 4023, '网页标题');
INSERT INTO `codedetail` VALUES (40, 4021, '断言方式类型', 40211, '元素被选中');
INSERT INTO `codedetail` VALUES (41, 4021, '断言方式类型', 40212, '元素可编辑');
INSERT INTO `codedetail` VALUES (42, 4021, '断言方式类型', 40213, '元素存在');
INSERT INTO `codedetail` VALUES (43, 4021, '断言方式类型', 40214, '元素不存在');
INSERT INTO `codedetail` VALUES (44, 4021, '断言方式类型', 40215, '元素未被选中');
INSERT INTO `codedetail` VALUES (45, 4021, '断言方式类型', 40216, '元素不可编辑');
INSERT INTO `codedetail` VALUES (46, 4021, '断言方式类型', 40217, '元素文本不等于期望值');
INSERT INTO `codedetail` VALUES (47, 4021, '断言方式类型', 40218, '元素文本等于期望值');
INSERT INTO `codedetail` VALUES (48, 4021, '断言方式类型', 40219, '元素文本不包含期望值');
INSERT INTO `codedetail` VALUES (49, 4021, '断言方式类型', 402110, '元素文本包含期望值');
...
CREATE TABLE `module`  (
  ...
  `fathernode_id` bigint NOT NULL COMMENT '模块父节点id',
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '模块创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of project
-- ----------------------------
INSERT INTO `project` VALUES (12398, '分类分级', '2023-06-29 11:08:33', 000, '2023-06-29 11:08:33');
INSERT INTO `project` VALUES (123981, '测试项目', '2023-06-29 11:23:47', 000, '2023-06-29 11:11:31');
INSERT INTO `project` VALUES (1239811, '资产', '2023-06-29 11:34:18', 000, '2023-06-29 11:34:18');
